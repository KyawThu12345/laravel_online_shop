                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-gallery">
                                    ...
                                    <div class="product-image-slider slick-initialized slick-slider">
                                        <div class="slick-list draggable">
                                            <div class="slick-track"
                                                style="opacity: 1; width: 5040px; transform: translate3d(-336px, 0px, 0px);">
                                                ...
                                                @endforeach
                                                {{-- <figure class="border-radius-10 slick-slide" data-slick-index="2"
                                                    --}} {{-- aria-hidden="true" tabindex="-1" style="width: 336px;">
                                    ...
                                    <div class="slider-nav-thumbnails pl-15 pr-15 slick-initialized slick-slider">
                                        <button type="button" class="slick-prev slick-arrow" style=""><i
                                                class="fi-rs-angle-left"></i></button> --}}
                                        {{-- <div class="slick-list draggable">
                                            <div class="slick-track"
                                                style="opacity: 1; width: 1178px; transform: translate3d(-310px, 0px, 0px);">
                                                <div class="slick-slide slick-cloned" data-slick-index="-5" id=""
                                                    aria-hidden="true" tabindex="-1" style="width: 56px;"><img
                                                        src="assets/imgs/shop/thumbnail-5.jpg" alt="product image">
                                                </div>
                                                <div class="slick-slide slick-cloned" data-slick-index="-4" id=""
                                                    aria-hidden="true" tabindex="-1" style="width: 56px;"><img
                                                        src="assets/imgs/shop/thumbnail-6.jpg" alt="product image">
                                                </div>
                                                <div class="slick-slide slick-cloned" data-slick-index="-3" id=""
                                                    aria-hidden="true" tabindex="-1" style="width: 56px;"><img
                                                        src="assets/imgs/shop/thumbnail-7.jpg" alt="product image">
                                                </div>
                                                <div class="slick-slide slick-cloned" data-slick-index="-2" id=""
                                                    aria-hidden="true" tabindex="-1" style="width: 56px;"><img
                                                        src="assets/imgs/shop/thumbnail-8.jpg" alt="product image">
                                                </div>
                                                <div class="slick-slide slick-cloned" data-slick-index="-1" id=""
                                                    aria-hidden="true" tabindex="-1" style="width: 56px;"><img
                                                        src="assets/imgs/shop/thumbnail-9.jpg" alt="product image">
                                                </div>
                                                <div class="slick-slide slick-current" data-slick-index="0"
                                                    aria-hidden="false" tabindex="0" style="width: 56px;"><img
                                                        src="assets/imgs/shop/thumbnail-3.jpg" alt="product image">
                                                </div>
                                                <div class="slick-slide" data-slick-index="1" aria-hidden="false"
                                                    tabindex="0" style="width: 56px;"><img
                                                        src="assets/imgs/shop/thumbnail-4.jpg" alt="product image">
                                                </div>
                                                ...
                                                <div class="slick-slide" data-slick-index="5" aria-hidden="true"
                                                    tabindex="-1" style="width: 56px;"><img
                                                        src="assets/imgs/shop/thumbnail-8.jpg" alt="product image">
                                                </div>
                                        ...
                                        {{-- <button type="button" class="slick-next slick-arrow" style=""><i
                                                class="fi-rs-angle-right"></i></button>
                                    </div>
                                </div>
                                <!-- End Gallery -->
                                <div class="social-icons single-share">
                                    <ul class="text-grey-5 d-inline-block">
                                        ...
                                        <li class="social-facebook"><a href="www.facebook.com"><img
                                                    src="assets/imgs/theme/icons/icon-facebook.svg" alt=""></a></li>
                                        <li class="social-twitter"> <a href="www.twitter.com"><img
                                                    src="assets/imgs/theme/icons/icon-twitter.svg" alt=""></a></li>
                                        <li class="social-instagram"><a href="www.instagram.com"><img
                                                    src="assets/imgs/theme/icons/icon-instagram.svg" alt=""></a></li>
                                        <li class="social-linkedin"><a href="www.pinterest.com"><img
                                            ...
                                            <div class="product-img-action-wrap">
                                                ...
                                                <div class="product-action-1">
                                                    <a aria-label="Add To Wishlist" class="action-btn small hover-up"
                                                        href="{{ route('shop.wishlist') }}" tabindex="0"><i
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="single-post clearfix">
                                ...
                                <div class="content pt-10">
                                    <h5><a href="{{ route('product.details', ['slug' => $product->slug]) }}">
                                            {{$product->name }}</a></h5>
