<div>
    <main class="main">
                        ...
                        <div class="row align-items-center slider-animated-1">
                            <div class="col-lg-5 col-md-6">
                                <div class="hero-slider-content-2">
                                    ...
                                    <a class="animated btn btn-brush btn-brush-2" href="{{ route('shop') }}">{{ $slide->status }}</a>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-6">
                                <div class="single-slider-img single-slider-img-1">
                                    <img class="animated slider-1-2" src="{{ asset('assets/imgs/shop/products/slide/' . $slide->image) }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="product-tabs section-padding position-relative wow fadeIn animated" style="visibility: visible;">
