                            ...
                            <div class="form-group">
                                <div class="custom_select">
                                    <select class="form-control select-active">
                                        ...
                                        <option value="CD">Cote d'Ivoire</option>
                                        ...
                                        <option value="DC">Democratic Republic of the Congo</option>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="product-subtotal" colspan="2">${{
                                                number_format(session('discounted_values.subtotalAfterDiscount'),2)
                                                }}
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="product-subtotal" colspan="2">${{
                                                number_format(session('discounted_values.taxAfterDiscount'), 2) }}
                                            </td>
                                        </tr>
                                        <tr>
