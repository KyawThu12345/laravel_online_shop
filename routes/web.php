...
Route::middleware('auth')->group(function () {
    ...
    // Route::get('/user/address', UserAddressComponent::class)->name('user.address');
});

// Route::middleware('auth')->post('/admin/new', [AdminNewComponent::class, 'createAdmin'])->name('admin.new.create');
